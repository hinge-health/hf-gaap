        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={12}>
            <FormControl required fullWidth>
              ...
              <FormLabel error color='warning'>
                Submission Mode may send PHI externally - please run Preview
                Mode first to confirm parameters!
              </FormLabel>
            </FormControl>
          </Grid>
          <Grid item xs={12} sm={12}>
            <CustomAutoComplete
              options={data.partnerships}
              fieldLabel='Choose a partnership'
              formId='partnership-select'
            />
          </Grid>
          <Grid item xs={12} sm={12}>
            <CustomAutoComplete
              options={data.clients}
              fieldLabel='Choose a client'
              formId='client-select'
            />
          </Grid>
          <Grid item xs={12} sm={12}>
            <CustomAutoComplete
              options={data.insurers}
              fieldLabel='Choose an insurer'
              formId='insurer-select'
            />
          </Grid>
          <Grid item xs={12} sm={12}>
            <FormControl required fullWidth>
